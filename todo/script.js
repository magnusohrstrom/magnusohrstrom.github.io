...
divH1.style.backgroundColor = "#2c3e50";
...
divInput.style.backgroundColor= "#7AD6DB";
...
buttonAdd.style.background="linear-gradient(#5A97B5,#2c3e50)";
...
divTodo.style.backgroundColor = "#2c3e50";
divTodo.style.height = "100%";
divTodo.style.width = "314px";
